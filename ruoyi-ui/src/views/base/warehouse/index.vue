  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="仓库编码" prop="warehouseCode">
          <el-input v-model="form.warehouseCode" placeholder="请输入仓库编码" :disabled="form.warehouseId != null" />
        </el-form-item>
        <el-form-item label="仓库名称" prop="warehouseName">
...
<script>
import { listWarehouse, getWarehouse, delWarehouse, addWarehouse, updateWarehouse, printWarehouse } from "@/api/base/warehouse";
...
export default {
  ...
  methods: {
    ...
    //打印
    handlePrint(row){
      printWarehouse(row.warehouseId).then(response => {
        const binaryData = [];
