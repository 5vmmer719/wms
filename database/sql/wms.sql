/*
 ...
 ============================================================
 MySQL 5.6.49 兼容性说明 (2026-03-31)
 ============================================================
 
 重要提示:
 1. 本文件包含 qrtz_* 相关的 Quartz 调度表,这些表在 MySQL 5.6.49 
    使用 utf8mb4 字符集时会出现索引长度超限问题
    
 2. 如果遇到 "specified key was too long; max key length is 767 bytes" 错误,
    请使用单独优化过的 qrtz 表文件: wms_qrtz_mysql56.sql
    
 3. 推荐执行顺序:
    - 先执行本文件创建所有表(可能 qrtz 表会报错,可忽略)
    - 然后执行 wms_qrtz_mysql56.sql 重新创建 qrtz 表
    
 4. wms_qrtz_mysql56.sql 优化说明:
    - 将 qrtz 表的字符集从 utf8mb4 改为 utf8
    - 缩短了部分 varchar 字段长度
    - 确保联合主键索引不超过 767 字节限制
...
INSERT INTO `sys_menu` VALUES (3, '系统工具', 0, 44, 'tool', NULL, '', 1, 0, 'M', '0', '1', '', 'tool', 'admin', '2022-07-10 01:24:55', 'admin', '2022-07-14 08:06:06', '系统工具目录');
...
INSERT INTO `sys_menu` VALUES (101, '角色管理', 1, 2, 'role', 'system/role/index', '', 1, 0, 'C', '0', '1', 'system:role:list', 'peoples', 'admin', '2022-07-10 01:24:55', '', NULL, '角色管理菜单');
INSERT INTO `sys_menu` VALUES (102, '菜单管理', 1, 3, 'menu', 'system/menu/index', '', 1, 0, 'C', '0', '1', 'system:menu:list', 'tree-table', 'admin', '2022-07-10 01:24:55', '', NULL, '菜单管理菜单');
INSERT INTO `sys_menu` VALUES (103, '部门管理', 1, 4, 'dept', 'system/dept/index', '', 1, 0, 'C', '0', '1', 'system:dept:list', 'tree', 'admin', '2022-07-10 01:24:55', '', NULL, '部门管理菜单');
INSERT INTO `sys_menu` VALUES (104, '岗位管理', 1, 5, 'post', 'system/post/index', '', 1, 0, 'C', '0', '1', 'system:post:list', 'post', 'admin', '2022-07-10 01:24:55', '', NULL, '岗位管理菜单');
...
INSERT INTO `sys_menu` VALUES (106, '参数设置', 1, 7, 'config', 'system/config/index', '', 1, 0, 'C', '0', '1', 'system:config:list', 'edit', 'admin', '2022-07-10 01:24:55', '', NULL, '参数设置菜单');
...
INSERT INTO `sys_menu` VALUES (110, '定时任务', 2, 2, 'job', 'monitor/job/index', '', 1, 0, 'C', '0', '1', 'monitor:job:list', 'job', 'admin', '2022-07-10 01:24:55', '', NULL, '定时任务菜单');
INSERT INTO `sys_menu` VALUES (111, '数据监控', 2, 3, 'druid', 'monitor/druid/index', '', 1, 0, 'C', '0', '1', 'monitor:druid:list', 'druid', 'admin', '2022-07-10 01:24:55', '', NULL, '数据监控菜单');
INSERT INTO `sys_menu` VALUES (112, '服务监控', 2, 4, 'server', 'monitor/server/index', '', 1, 0, 'C', '0', '1', 'monitor:server:list', 'server', 'admin', '2022-07-10 01:24:55', '', NULL, '服务监控菜单');
INSERT INTO `sys_menu` VALUES (113, '缓存监控', 2, 5, 'cache', 'monitor/cache/index', '', 1, 0, 'C', '0', '1', 'monitor:cache:list', 'redis', 'admin', '2022-07-10 01:24:55', '', NULL, '缓存监控菜单');
INSERT INTO `sys_menu` VALUES (114, '缓存列表', 2, 6, 'cacheList', 'monitor/cache/list', '', 1, 0, 'C', '0', '1', 'monitor:cache:list', 'redis-list', 'admin', '2022-07-10 01:24:55', '', NULL, '缓存列表菜单');
INSERT INTO `sys_menu` VALUES (115, '表单构建', 3, 1, 'build', 'tool/build/index', '', 1, 0, 'C', '0', '1', 'tool:build:list', 'build', 'admin', '2022-07-10 01:24:55', '', NULL, '表单构建菜单');
INSERT INTO `sys_menu` VALUES (116, '代码生成', 3, 2, 'gen', 'tool/gen/index', '', 1, 0, 'C', '0', '1', 'tool:gen:list', 'code', 'admin', '2022-07-10 01:24:55', '', NULL, '代码生成菜单');
INSERT INTO `sys_menu` VALUES (117, '系统接口', 3, 3, 'swagger', 'tool/swagger/index', '', 1, 0, 'C', '0', '1', 'tool:swagger:list', 'swagger', 'admin', '2022-07-10 01:24:55', '', NULL, '系统接口菜单');
...
INSERT INTO `sys_menu` VALUES (2170, '质检单查询', 2077, 1, '#', '', NULL, 1, 0, 'F', '0', '0', 'check:inOrder:query', '#', 'admin', '2022-07-23 09:33:44', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2171, '质检单审核', 2077, 2, '#', '', NULL, 1, 0, 'F', '0', '0', 'check:inOrder:check', '#', 'admin', '2022-07-23 09:33:44', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2172, '质检单导出', 2077, 3, '#', '', NULL, 1, 0, 'F', '0', '0', 'check:inOrder:export', '#', 'admin', '2022-07-23 09:33:44', '', NULL, '');
...
INSERT INTO `sys_menu` VALUES (2173, '出库退货查询', 2083, 1, '', NULL, NULL, 1, 0, 'F', '0', '0', 'stock:common:outReturn:query', '#', 'admin', '2022-07-29 07:31:06', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2174, '出库退货新增', 2083, 2, '', NULL, NULL, 1, 0, 'F', '0', '0', 'stock:common:outReturn:add', '#', 'admin', '2022-07-29 07:31:06', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2175, '出库退货修改', 2083, 3, '', NULL, NULL, 1, 0, 'F', '0', '0', 'stock:common:outReturn:edit', '#', 'admin', '2022-07-29 07:31:06', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2176, '出库退货删除', 2083, 4, '', NULL, NULL, 1, 0, 'F', '0', '0', 'stock:common:outReturn:remove', '#', 'admin', '2022-07-29 07:31:06', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2177, '出库退货导出', 2083, 5, '', NULL, NULL, 1, 0, 'F', '0', '0', 'stock:common:outReturn:export', '#', 'admin', '2022-07-29 07:31:06', '', NULL, '');
...
-- Records of sys_post
-- ----------------------------
INSERT INTO `sys_post` VALUES (1, 'admin', '系统管理员', 1, '0', 'admin', '2022-07-10 01:24:55', '', NULL, '');
INSERT INTO `sys_post` VALUES (2, 'stockkeeper', '库管员', 2, '0', 'admin', '2022-07-10 01:24:55', '', NULL, '');
INSERT INTO `sys_post` VALUES (3, 'inspector', '质检员', 3, '0', 'admin', '2022-07-10 01:24:55', '', NULL, '');
INSERT INTO `sys_post` VALUES (4, 'planner', '计划员', 4, '0', 'admin', '2022-07-10 01:24:55', '', NULL, '');
...
INSERT INTO `sys_role` VALUES (3, '库管员', 'stockkeeper', 3, '1', 1, 1, '0', '0', 'admin', '2022-07-10 01:24:55', '', NULL, '负责仓库收发货、库存管理、调拨管理');
INSERT INTO `sys_role` VALUES (4, '质检员', 'inspector', 4, '1', 1, 1, '0', '0', 'admin', '2022-07-10 01:24:55', '', NULL, '负责入库物料质量检验');
INSERT INTO `sys_role` VALUES (5, '计划员', 'planner', 5, '1', 1, 1, '0', '0', 'admin', '2022-07-10 01:24:55', '', NULL, '负责生产计划、物料数据维护');
...
-- 角色权限分配说明：
-- role_id=1 超级管理员(admin): 框架自动拥有全部权限，无需配置
-- role_id=2 普通角色(common): 保留，仅关联系统管理中可用的菜单
-- role_id=3 库管员(stockkeeper): 数据管理(只读)+采购管理(全部)+库存管理(全部)+调拨管理(全部)+通用管理(全部)+统计管理(只读)
-- role_id=4 质检员(inspector): 数据管理(只读)+质检管理(全部)+采购管理-入库单(只读)+统计管理(只读)
-- role_id=5 计划员(planner): 数据管理(全部CRUD)+生产管理(全部)+采购管理(只读)+库存管理(只读)+统计管理(全部)
-- ----------------------------
-- ====== role_id=2 普通角色 - 仅保留未停用的系统管理菜单 ======
...
INSERT INTO `sys_user` VALUES (101, 100, 'stockkeeper', '库管员', '00', '', '', '0', '', '$2a$10$76b1MOVniaux2ACn9XYM4u0C2dLgvJqjNWWR2TGQzLKBaPdak6m/K', '0', '0', '', NULL, 'admin', '2022-07-10 01:24:55', '', NULL, '库管员账号，初始密码admin123');
INSERT INTO `sys_user` VALUES (102, 100, 'inspector', '质检员', '00', '', '', '0', '', '$2a$10$76b1MOVniaux2ACn9XYM4u0C2dLgvJqjNWWR2TGQzLKBaPdak6m/K', '0', '0', '', NULL, 'admin', '2022-07-10 01:24:55', '', NULL, '质检员账号，初始密码admin123');
INSERT INTO `sys_user` VALUES (103, 100, 'planner', '计划员', '00', '', '', '0', '', '$2a$10$76b1MOVniaux2ACn9XYM4u0C2dLgvJqjNWWR2TGQzLKBaPdak6m/K', '0', '0', '', NULL, 'admin', '2022-07-10 01:24:55', '', NULL, '计划员账号，初始密码admin123');
...
INSERT INTO `sys_user_class` VALUES ('stockkeeper', 'LS');
INSERT INTO `sys_user_class` VALUES ('stockkeeper', 'TH');
INSERT INTO `sys_user_class` VALUES ('stockkeeper', 'ZC');
INSERT INTO `sys_user_class` VALUES ('inspector', 'LS');
INSERT INTO `sys_user_class` VALUES ('inspector', 'TH');
INSERT INTO `sys_user_class` VALUES ('inspector', 'ZC');
INSERT INTO `sys_user_class` VALUES ('planner', 'LS');
INSERT INTO `sys_user_class` VALUES ('planner', 'TH');
INSERT INTO `sys_user_class` VALUES ('planner', 'ZC');
